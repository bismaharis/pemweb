  ...
  <header class="bg-white fixed top-0 left-0 w-full shadow z-50 transition-opacity">
    <div class="container mx-auto px-6 py-3 flex justify-between items-center">
      ...
      <nav id="nav-menu" class="hidden lg:flex space-x-4 m-auto bg-[#F7F7FD] p-3 pl-12 pr-12 rounded-full">
        <a href="dashboard.php" class="text-gray-600 hover:text-blue-600">Home</a>
      ...
      <nav class="hidden lg:flex items-center space-x-4">
        ...
        <?php if (isset($_SESSION["is_login"]) && $_SESSION["is_login"]) { ?>
          ...
          <a href="logout.php" class="px-4 py-2 bg-white shadow text-black rounded-3xl hover:bg-blue-600 ml-4 hover:text-white">Logout</a>
        <?php } else { ?>
    ...
    <div id="mobile-menu" class="hidden lg:hidden">
      <nav class="bg-white px-2 pt-2 pb-4 space-y-1">
        <a href="dashboard.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600">Home</a>
        <a href="About.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600">About Us</a>
        <a href="Services.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600">Services</a>
        <a href="contact.php" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-50 hover:text-blue-600">Contact Us</a>
        <!-- Language Dropdown Start -->
