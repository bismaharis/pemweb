        ...
        <div class="mt-4 p-2 bg-gray-100 rounded shadow">
          ...
          <div class="p-4 border rounded bg-white text-center shadow">
            ...
            <form id="uploadForm" method="POST" action="upload.php" enctype="multipart/form-data">
              <input type="hidden" name="content_type" value="Google">
              <input type="hidden" name="redirect_page" value="contentgo.php">
      ...
      <div>
        ...
        <div class="mt-4">
          ...
          <div class="flex space-x-4">
            <button class="bg-gray-200 text-gray-600 px-4 py-2 rounded hover:bg-gray-300" type="button" onclick="saveOrderAndPay()">Bayar</button>
