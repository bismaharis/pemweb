...
<html lang="en">
  <head>
    ...
    <!-- Swiper News Start -->
    <section class="relative text-center max-w-6xl mx-auto p-8 m-56">
      ...
      <div class="absolute top-2/3 max-w-md">
        <div class="swiper-wrapper">
          <!-- Slide 1 -->
          <div class="swiper-slide testimonial-card bg-white p-8 rounded-lg shadow-lg mr-4">
          ...
          <!-- Slide 2 -->
          <div class="swiper-slide testimonial-card bg-white p-8 rounded-lg shadow-lg mx-2 mr-4">
            <div class="flex items-center mb-2">
                <div class="flex-shrink-0">
        ...
        <div class="flex flex-wrap justify-between">
          <div class="w-full md:w-1/4 mb-4 md:mb-0">
            ...
            <ul>
              <li>
                <a
                  href="#employee-database"
                  class="text-gray-600 hover:text-gray-900"
                  >Employee database</a
                >
              </li>
              <li>
                <a href="#payroll" class="text-gray-600 hover:text-gray-900"
                  >Payroll</a
                >
              </li>
              <li>
                <a href="#absences" class="text-gray-600 hover:text-gray-900"
                  >Absences</a
                >
              </li>
              <li>
              ...
              <li>
                <a href="#recruiting" class="text-gray-600 hover:text-gray-900"
                  >Recruiting</a
                >
              </li>
            </ul>
          ...
          <div class="w-full md:w-1/4 mb-4 md:mb-0">
            ...
            <ul>
              <li>
                <a href="#about-us" class="text-gray-600 hover:text-gray-900"
                  >About us</a
                >
              </li>
              <li>
              ...
              <li>
                <a href="#contact-us" class="text-gray-600 hover:text-gray-900"
                  >Contact us</a
                >
              </li>
              <li>
                <a href="#lift-media" class="text-gray-600 hover:text-gray-900"
                  >Lift Media</a
                >
              </li>
            </ul>
          </div>
          <div class="w-full md:w-1/4 p-8 bg-gray-200 rounded-xl">
            <h5 class="text-lg font-semibold mb-4">Subscribe</h5>
            <form id="subscribe-form" class="flex items-center rounded-full">
              <input
                type="email"
                id="email-address"
                class="form-input w-full px-4 py-2 rounded-full border border-gray-300 focus:outline-none"
                placeholder="Email address" />
              <button
                type="submit"
                class="bg-blue-500 -z-1 -ml-10 text-white px-4 py-2 rounded-full hover:bg-blue-700">
                ➔
              </button>
            </form>
