    ...
    <footer class=" mt-auto py-8">
      <div class="container mx-auto px-4">
        ...
        <div class="w-full md:w-1/4 p-8 bg-gray-200 rounded-xl">
          ...
          <p class="text-gray-600 mt-2">Hello, we are Lift Media. Our goal is to translate the positive effects from revolutionizing how companies engage with their clients & their team.</p>
        </div>
    </div>
    <hr class="mt-8">
    <div class="flex mt-4">
